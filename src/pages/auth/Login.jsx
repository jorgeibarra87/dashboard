...
export default function Login() {
    ...
    return (
        <div className='bg-secondary-100 p-8 rounded-xl shadow-2xl w-auto lg:w-[450px] '>
            <h1 className="text-3xl text-center uppercase font-bold tracking-[4px] text-white mb-8 ">LogIn</h1>
            <form className="mb-8">
                ...
                <div>
                    <button type='submit' className='bg-primary text-black uppercase font-bold text-sm w-full py-3 px-4 rounded-lg '>Login</button>
                </div>
            </form>
            <div className='flex flex-col items-center gap-4'>
                <Link to="/auth/forgetpassword" className='hover:text-primary transition-colors'>¿Did you forget your password?</Link>
