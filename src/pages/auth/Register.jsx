...
export default function Register() {
    ...
    return (
        <div className='bg-secondary-100 p-8 rounded-xl shadow-2xl w-auto lg:w-[450px] '>
            <h1 className="text-3xl text-center uppercase font-bold tracking-[4px] text-white mb-8 ">Sign up</h1>
            <form className="mb-8">
                ...
                <div>
                    <button type='submit' className='bg-primary text-black uppercase font-bold text-sm w-full py-3 px-4 rounded-lg '>Sign Up</button>
                </div>
            </form>
